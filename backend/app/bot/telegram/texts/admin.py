...
ADMIN_RESULTS_PLAYER_PROMPTS = {
    "none": (
        "Введи результат игрока в формате:\n"
        "место\n"
        "Если места нет, поставь 0."
    ),
    "small": (
        "Введи результат игрока в формате:\n"
        "КО - место\n"
        "Можно ввести только КО. Если места нет, поставь 0."
    ),
    "small_big": (
        "Введи результат игрока в формате:\n"
        "КО - Босс КО - место\n"
        "Можно ввести только КО или КО - Босс КО. Если места нет, поставь 0."
    ),
}
ADMIN_RESULTS_INVALID_PLAYER_DATA = {
    "none": "Введи результат в формате: место.",
    "small": "Введи результат в формате: КО - место.",
    "small_big": "Введи результат в формате: КО - Босс КО - место.",
}
