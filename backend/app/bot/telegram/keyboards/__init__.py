from app.bot.telegram.keyboards.admin import (
    ...
    AdminResultCloseAction,
    AdminResultCloseCallback,
    AdminResultField,
    ...
    admin_result_close_confirmation_keyboard,
    admin_result_manual_value_keyboard,
    admin_result_menu_keyboard,
    admin_result_no_result_confirmation_keyboard,
    admin_result_no_result_players_keyboard,
    ...
    admin_tournament_registration_search_cancel_keyboard,
